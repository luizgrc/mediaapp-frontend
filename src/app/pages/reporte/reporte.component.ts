...
export class ReporteComponent implements OnInit {
  ...
  constructor(private consultaService: ConsultaService , private sanatization : DomSanitizer) {}
  ...
  setear( x : any){
    this.imagenData = this.sanatization.bypassSecurityTrustResourceUrl(x);
  }
